...
<div class="l-cont">
    ...
    <main class="l-main">
        ...
        <section class="p-archive c-frame_page">
            <div class="p-content-inner">
                <div class="p-about_ttl c-secTtl">
                    <figure class="p-about_ttlImg c-secTtl_img"><img src="<?php echo esc_url(get_template_directory_uri() . "/img/ttl_upper/blog-list_ttl.png"); ?>" alt="ttl-img"></figure>
                    <h3>
